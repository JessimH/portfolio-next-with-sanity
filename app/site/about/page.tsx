          ...
          <div key={data._id}>
            <section className="grid lg:grid-cols-2 grid-cols-1 gap-x-6 justify-items-center">
              <div className="order-2 lg:order-none">
                ...
                <div className="flex flex-col gap-y-3 text-emerald-100 leading-relaxed">
              ...
              <div className="flex flex-col lg:justify-self-center justify-self-start gap-y-8 lg:order-1 order-none mb-12">
                <div>
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-x-2 bg-emerald-900 border border-transparent hover:scale-105 rounded-md duration-200 py-2 text-center cursor-cell font-medium"
                  >
                ...
                <ul>
                  <li>
                    <a
                      ...
                      className="flex items-center gap-x-2 hover:text-emerald-900 duration-300"
                    >
